...
TcellAveTop_vs_PSCTamb = zeros(length(Tamb),countTlimit);
TcellAveBack_vs_PSCTamb = zeros(length(Tamb),countTlimit);
...
try 
    ...
    TcellAveTop_vs_PSCTamb(idxTamb,countT) = TcellAveTop;
    TcellAveBack_vs_PSCTamb(idxTamb,countT) = TcellAveBack;
...
TcellAveTop_vs_PSCIrradiance = zeros(length(Irradiance),countTlimit);
TcellAveBack_vs_PSCIrradiance = zeros(length(Irradiance),countTlimit);
...
try 
    ...
    TcellAveTop_vs_PSCIrradiance(idxIrr,countT) = TcellAveTop;
    TcellAveBack_vs_PSCIrradiance(idxIrr,countT) = TcellAveBack;
...
TcellAveTop_vs_PSCWindspeed = zeros(length(v_wind),countTlimit);
TcellAveBack_vs_PSCWindspeed = zeros(length(v_wind),countTlimit);
...
try 
    ...
    TcellAveTop_vs_PSCWindspeed(idxv_wind,countT) = TcellAveTop;
    TcellAveBack_vs_PSCWindspeed(idxv_wind,countT) = TcellAveBack;
...
TcellAveTop_vs_SiTamb = zeros(length(Tamb),countTlimit);
TcellAveBack_vs_SiTamb = zeros(length(Tamb),countTlimit);
...
try 
    ...
    TcellAveTop_vs_SiTamb(idxTamb,countT) = TcellAveTop;
    TcellAveBack_vs_SiTamb(idxTamb,countT) = TcellAveBack;
...
TcellAveTop_vs_SiIrradiance = zeros(length(Irradiance),countTlimit);
TcellAveBack_vs_SiAll = zeros(length(Irradiance),countTlimit);
...
try 
    ...
    TcellAveTop_vs_SiIrradiance(idxIrr,countT) = TcellAveTop;
    TcellAveBack_vs_SiAll(idxIrr,countT) = TcellAveBack;
...
TcellAveTop_vs_SiWindspeed = zeros(length(v_wind),countTlimit);
TcellAveBack_vs_SiWindspeed = zeros(length(v_wind),countTlimit);
...
try 
    ...
    TcellAveTop_vs_SiWindspeed(idxv_wind,countT) = TcellAveTop;
    TcellAveBack_vs_SiAll(idxv_wind,countT) = TcellAveBack;
